...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
            ...
            <div className="group relative">
                ...
                <div className="group-hover:block hidden absolute  dropdown-menu right-0 pt-4">
                    <div className="flex flex-col gap-2 w-36 py-2 px-5 bg-slate-100 text-gray-500 rounded">
                        <p className="cursor-pointer hover text-black">Hồ sơ của bạn</p>
        ...
        <img onClick={()=>setVisible(true)} src ={menu} alt='' className="w-5 cursor-pointer sm:hidden" />
        </div>
        {/* reponsive slidebar */}
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
            <div className="flex flex-col text-gray-600">
                <div onClick={()=>setVisible(false)} className="flex items-center gap-4 p-3 cursor-pointer">
                    <img src={back} alt='' className="h-4 rotate-180"/>
                    <p>Trở lại</p>
                </div>
